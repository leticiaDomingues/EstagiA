...
public class MyDB {
    ...
    public static void populateDB() {
        if(firstExecution) {
            ...
            MyDB.addUser(new User("Marcelo", "573124", "BCC", "marcelo@mail.com", "senha", false));
            ...
            MyDB.addEvent(new Event("Spotify", "Auditório DC", "logo_spotify", "15/01/2018", "Essa semana ocorrerá no auditório do Departamento de Computação uma palestra sobre a empresa Spotify."));
            MyDB.addEvent(new Event("Itaú", "Bento Prado Jr", "logo_itau", "14/02/2018", "Essa semana ocorrerá no Anfiteatro Bento Prado Junior uma palestra do Itaú sobre o processo seletivo."));
            MyDB.addEvent(new Event("Monitora", "Lab II DC", "logo_monitora", "17/07/2018", "Essa semana ocorrerá no Laboratório II do Departamento de Computação uma palestra sobre a empresa Monitora."));
            MyDB.addEvent(new Event("IBM", "Auditório DC", "logo_ibm", "16/09/2018", "Essa semana ocorrerá no auditório do Departamento de Computação uma palestra sobre a empresa IBM."));
            MyDB.addEvent(new Event("Amazon", "Auditório DC", "logo_amazon", "20/03/2018", "Essa semana ocorrerá no auditório do Departamento de Computação uma palestra sobre a empresa Amazon."));
            MyDB.addEvent(new Event("Motorola", "Bento prado Jr", "logo_motorola", "21/03/2018", "Essa semana ocorrerá no Anfiteatro Bento Prado Junior uma palestra sobre a empresa Motorola."));
